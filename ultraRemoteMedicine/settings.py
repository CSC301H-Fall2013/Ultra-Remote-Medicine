...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join('sqlite3.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '5g#g)g#wz)=pa^42t(jzy*9z=cihq2v^gacb78z53azr#+1z*t'
...
ROOT_URLCONF = 'ultraRemoteMedicine.urls'
